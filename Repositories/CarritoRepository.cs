...
namespace CRACKED.Repositories
{
    public class CarritoRepository
    {
        ...
        public CarritoRepository(CRACKEDEntities41 context)
        {
            _context = context;
        }
        public bool ActualizarPedido(PedidoDto pedido)
        {
            using (var db = new CRACKEDEntities41()) // Asegúrate de usar tu contexto adecuado
            {
...
<th style='padding: 10px; border: 1px solid #ddd;'>Producto</th>
        ...
        {
            using (var db = new CRACKEDEntities41 ())  // Usamos el contexto de la base de datos
            {
