...
namespace CRACKED.Repositories
{
    public class ProductRepository
    {
        public bool GuardarProducto(PRODUCTO producto)
        {
            try
            {
                using (var db = new CRACKEDEntities37()) // Usando el contexto de tu base de datos
                {
        ...
        public ProductListDto ObtenerProductosAdmin()
        {
            ...
            try
            {
                using (var db = new CRACKEDEntities37())  // Asegúrate de usar el nombre de tu contexto
                {
